...
- **Bugs & issues:** open a GitHub issue, or email **`mrdeveloper.outlast170@passinbox.com`**
- **Security reports:** **`mrdeveloper.outlast170@passinbox.com`** (private — see [SECURITY.md](SECURITY.md))
- **Everything else** (questions, exchange requests, ideas): `mrdeveloper.outlast170@passinbox.com`

## License

Apache License 2.0 — see `LICENSE` and `NOTICE`. A clean-data **Portable Edition** lives in `Portable version/Any-WALLEX-Portable/`.
